...
public class Produto
{
    ...
    [StringLength(10, ErrorMessage = "O SKU Resumida deve possuir no máximo 10 caracteres")]
    ...
    [StringLength(30, ErrorMessage = "O  Material Resumida deve possuir no máximo 30 caracteres")]
    public string Material { get; set; }

    [Display(Name ="Dimensão")]
    [StringLength(30, ErrorMessage = "A Dimensão Resumida deve possuir no máximo 30 caracteres")]
